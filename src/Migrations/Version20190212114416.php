 ...
 */
final class Version20190212114416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, user_property_id INT DEFAULT NULL, property_category VARCHAR(255) NOT NULL, unique_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code INT NOT NULL, country VARCHAR(255) NOT NULL, surface_in_square_meter INT NOT NULL, number_of_piece INT NOT NULL, description LONGTEXT DEFAULT NULL, equipment LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', rental_category VARCHAR(255) NOT NULL, rent_excluding_charges DOUBLE PRECISION NOT NULL, charges DOUBLE PRECISION NOT NULL, purchase_price DOUBLE PRECISION NOT NULL, INDEX IDX_8BF21CDEFD89DA79 (user_property_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
