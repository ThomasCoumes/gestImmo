...
final class Version20190215093912 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, property_category VARCHAR(11) NOT NULL, unique_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code INT NOT NULL, country VARCHAR(255) NOT NULL, surface_in_square_meter INT NOT NULL, number_of_piece INT NOT NULL, description LONGTEXT DEFAULT NULL, rental_category VARCHAR(10) NOT NULL, rent_excluding_charges DOUBLE PRECISION NOT NULL, charges DOUBLE PRECISION NOT NULL, purchase_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
